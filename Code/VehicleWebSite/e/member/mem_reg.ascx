...
<tr id="tr_member_vcode">
 ...
 <td><input type='textbox' name='vcode' maxlength='4' style="width:80px" class="m_tb" onkeyup="if(isNaN(value))execCommand('undo')" onfocus='Code_Change("regcode")'>&nbsp;<img src='/e/aspx/yzm.aspx' onclick='Code_Change("regcode")' align=absmiddle border=0 id='regcode' style='cursor:pointer;height:20px'  alt='点击更换'></td>
</tr>
