...
<tr id='tr_article_pa_style'><td class='tdhead'>标题样式</td><td><input type=text name='pa_style' id='pa_style' value="<%if(post=="add"){Response.Write("");}else{Response.Write(r("pa_style"));}%>"  maxlength='100' ><span id="pa_style_tip"></span></td></tr>
