        ...
        <td  align="left">
           <table border=0 cellpadding=0 cellspacing=0 width=100% class="tablestyle tb_datalist" id="tb_datalist">
                <tr class="header">
                  ...
                  <td noWrap>职位名称</td><td noWrap>发布日期</td>
                  <td noWrap>发布人</td>
                  <td noWrap>点击</td>
                  <td noWrap>评论</td>
             ...
             <ItemTemplate>
                 <tr class="listitem">
                  ...
                  <td nowrap align="center">
                   ...
                   <a href="javascript:EditInfo('data_add.aspx?id=<%#DataBinder.Eval(Container.DataItem,"id")%>&table=<%#Request.QueryString["table"]%>&name=<%#Request.QueryString["name"]%>')">编辑</a>
