...
<li class="login_item_2">&nbsp;<input type="password" maxlength="16" class="m_tb m_tb_width" name="password" id="password" /> <a href="<%=Get_Url("find_pass")%>">忘记密码?</a>
</li>

<li class="login_item_jiange"></li>

<li class="login_item_1">验证码： </li>
<li class="login_item_2">&nbsp;<input type='textbox' name='vcode' class='m_tb' maxlength='4' style="width:50px">&nbsp;<img src='/e/aspx/yzm.aspx' onclick='Code_Change("logincode")' align=absmiddle border=0 id='logincode' style='cursor:pointer;width:50px;height:18px'  alt='点击更换'>
</li>
<li class="login_item_jiange"></li>
<li class="login_item_jiange"><input type="hidden" name="login"  value="yes"><input type="hidden" name="To_Url" value="<%=To_Url%>"></li>
<li class="login_submit_box">&nbsp;<input type="submit"  value="登 录"  onclick="return login_check()" class="bt"></li>
