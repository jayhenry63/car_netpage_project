...
<%if(Price!="" && Price!="0"){%>产品价格：<%=Price%>元 &nbsp;<a href="javascript:ordercart('<%=Site_Id%>','product',<%=Id%>)" style="color:#ff0000">[在线订购]</a><br><%}%>
...
<div><input type="hidden" id="currentimage"><a href=javascript:ShowImage()><img align=absmiddle hspace=2 src=/e/images/public/zoom.gif border=0 width=24px height=24px>查看大图</a></div>
</li>
<li class="clear"></li>
</ul>
</div>
