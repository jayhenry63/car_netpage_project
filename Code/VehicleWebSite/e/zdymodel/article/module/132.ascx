...
<%}%><%conn.Open();%><div class="left" style="width:3%;padding:60px 0 40px 0;cursor:pointer" onclick="c_direction('left')"><img src="/e/images/diy/left_btn.gif" border=0 width=12></div>
