...
<TABLE width=500 border=0 align="center" cellPadding=5 cellSpacing=0>
   ...
   <TR> 
	<TD vAlign=top align="left">支付订单号：<%=Request.QueryString["pay_no"]%></TD>
   </TR>
   <TR> 
      <TD vAlign=top align="left">支付平台：<%=Request.QueryString["pay_type"]%></TD>
   </TR>
   <TR> 
       <TD vAlign=top align="left">充值金额：<span style="color:#ff0000;Font-Size:13px;font-weight:bold">￥<%=Request.QueryString["pay_amount"]%></span></TD>
   </TR>
   <TR> 
