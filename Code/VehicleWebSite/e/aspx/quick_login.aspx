...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		<td>验证码：</td>
		<td align="left"><input type="text" name="vcode" id="vcode" class="inputbox yzm" maxlength="4" onfocus="Code_Change('yzmcode')" /> <img src='/e/aspx/yzm.aspx' onclick="Code_Change('yzmcode')"  align=absmiddle border=0 id='yzmcode'  alt='点击更换' style='cursor:pointer;height:20px' ></td>
	</tr>
