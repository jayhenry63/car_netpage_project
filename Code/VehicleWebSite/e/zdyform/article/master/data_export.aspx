...
<asp:Repeater id="DL_1"  runat="server">
   <HeaderTemplate>
     <table border=1>
      <tr><td align=center>title</td><td align=center>titlepic</td><td align=center>thedate</td><td align=center>pa_autor</td><td align=center>pa_introduct</td><td align=center>content</td><td align=center>pa_source</td><td align=center>pa_style</td><td align=center>pa_fj</td><td align=center>pa_video</td><td align=center>pa_pics</td><td align=center>clicks</td><td align=center>comments</td><td align=center>downloads</td><td align=center>reserves</td></tr>
   </HeaderTemplate>
   <ItemTemplate>  
      <tr><td align=center><%#DataBinder.Eval(Container.DataItem,"title")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"titlepic")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"thedate")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_autor")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_introduct")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"content")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_source")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_style")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_fj")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_video")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"pa_pics")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"clicks")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"comments")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"downloads")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"reserves")%></td></tr>
    </ItemTemplate> 
   <FooterTemplate>
     </table>
   </FooterTemplate>
