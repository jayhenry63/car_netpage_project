...
<li class="login_item_2">&nbsp;<input type='textbox' name='vcode' class='m_tb' maxlength='4' style="width:50px" onfocus='Code_Change("logincode")'>&nbsp;<img src='/e/aspx/yzm.aspx' onclick='Code_Change("logincode")' align=absmiddle border=0 id='logincode' style='cursor:pointer;height:20px'  alt='点击更换'>
</li>
<li class="login_item_jiange"></li>
