...
<a href="<%#Get_Url(DataBinder.Eval(Container.DataItem,"id").ToString(),DataBinder.Eval(Container.DataItem,"thetype").ToString(),DataBinder.Eval(Container.DataItem,"lanmu_dir").ToString(),DataBinder.Eval(Container.DataItem,"zdy_url").ToString())%>" target=_blank><img src=images/sign_detail.gif border=0 title="预览" align="absmiddle"></a>
                  ...
                  <td align=left  class=tdstyle><span style="display:<%#DataBinder.Eval(Container.DataItem,"thetype").ToString()=="external"?"none":""%>"><%#DataBinder.Eval(Container.DataItem,"site_dir").ToString()==""?"/":"/"+DataBinder.Eval(Container.DataItem,"site_dir").ToString()+"/"%><asp:TextBox id="Tb_lanmudir" Text='<%#DataBinder.Eval(Container.DataItem,"lanmu_dir")%>' runat="server" size=10 maxlength="40" /></span><span style="display:<%#DataBinder.Eval(Container.DataItem,"thetype").ToString()=="external"?"":"none"%>"><asp:TextBox id="Tb_url" Text='<%#DataBinder.Eval(Container.DataItem,"zdy_url")%>' runat="server" size=15 maxlength="80" /></span></td>
                ...
                <td align=center class=tdstyle nowrap>
                  ...
                  <td align=left class=tdstyle nowrap>
                   ...
                   <asp:Hyperlink id="Lanmu_Set"  runat="server"  NavigateUrl='<%#"javascript:General_Set(\"栏目设置\",\"lanmu_set.aspx?&id="+DataBinder.Eval(Container.DataItem,"id")+"&lanmu="+DataBinder.Eval(Container.DataItem,"name").ToString()+"\")"%>'  Text="栏目设置" />
