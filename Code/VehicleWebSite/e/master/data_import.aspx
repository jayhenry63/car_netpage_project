...
private void Load_Data()
 {
  ...
  try
   ...
   //strConn="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" +excle_path+ ";Excel 8.0;HDR=YES";//此连接只能操作Excel2007之前(.xls)文件
...
private void Get_Lanmu(int Sort_Id)
 {
   ...
   sql="select id,lanmu_id,[detail_html] from pa_sublanmu where is_sortsublanmu=1 and site_id="+SiteId+" and sort_id=0 and thetable='"+TheTable+"'";
   Comm=new OleDbCommand(sql,conn);
   dr=Comm.ExecuteReader();
   if(dr.Read())
    {
