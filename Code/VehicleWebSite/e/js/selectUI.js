...
(function($){
	...
	_SelectUI.prototype = {
		init : function(){
			...
			var cssStr = 	'<style>'+
							className + '{position:relative; width:'+_this.opts.width+'px; z-index:10;}'+
							...
							className + '.selectList{position: absolute;border:'+_this.opts.border+';width:'+(_this.opts.width-4)+'px; padding:1px; margin-top:-1px;cursor: default;background:'+_this.opts.background+';z-index:10;display:none;}'+
