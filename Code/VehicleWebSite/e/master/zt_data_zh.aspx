   ...
   switch(Act)
    {
      ...
      log.Save(int.Parse(Request.Cookies["SiteId"].Value),1,"edit",1,TheMaster,"组合专题信息");
      break;
...
<div id="tabdiv">
<ul>
<li id="tab" name="tab" onclick="location.href='zt_data.aspx?id=<%=Request.QueryString["id"]%>'">专题信息</li>
          ...
          <asp:Repeater id="P1" runat="server" OnItemDataBound="Data_Bound">         
             <ItemTemplate>
                 <tr class="listitem">
                  ...
                  <td align=center class=tdstyle><input type="button" class="button" value="加入" onclick="add(<%#DataBinder.Eval(Container.DataItem,"id")%>)" <%#DataBinder.Eval(Container.DataItem,"zt_ids").ToString().IndexOf(","+ZtId+",")>=0?"disabled":""%>></td>
                </tr>
             </ItemTemplate>
          </asp:Repeater>
        <tr>
...
<a href="javascript:set('add')">[加入到本专题]</a>
</td>
